...
<head>
    ...
    <title>Brian Muriungi - Personal portfolio</title>
    <!-- Favicon-->
                    ...
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                                <div class="text-uppercase">Software Developer &middot; Web Developer &middot; Data
                                    Administrator</div>
                            </div>
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-xxl-8">
                        <div class="text-center my-5">
                            ...
                            <p class="lead fw-light mb-4">My name is Kimathi Brian Muriungi and I develop Software
                                applications, web-based applications and manage data as a data administrator.</p>
                            <p class="text-muted">As a full stack programmer, I am proficient in front-end and back-end
                                development,
                                using languages like Html & CSS, Bootstrap, Php, JavaScript, React, Python and Java. I excel in debugging,
                                testing, and version control using tools
                                such as Git. Additionally, I manage databases (SQL), all while
                                participating in agile methodologies and continuously expanding my skill set.</p>
                            <div class="d-flex justify-content-center fs-2 gap-4">
                                <a class="text-gradient" href="https://x.com/bkimking" target="_blank"><i
                                        class="bi bi-twitter"></i></a>
                                <a class="text-gradient" href="https://www.linkedin.com/feed/" target="_blank"><i
                                        class="bi bi-linkedin"></i></a>
                                <a class="text-gradient" href="https://github.com/Bkimking" target="_blank"><i
